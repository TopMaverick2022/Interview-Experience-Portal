<%-- 
    Document   : AccHr
    Created on : 14-Dec-2024, 9:25:51 pm
    Author     : bala
--%>
    ...
    <div class="container">
        <%
            try {
                ...
                ResultSet rs = s.executeQuery("SELECT name, companyname, interview_date, description FROM hr WHERE companyname = 'Accenture'");

                while (rs.next()) {
        %>
                    <div class="card">
                        <h3>HR Name <%= rs.getString(1) %></h3>
