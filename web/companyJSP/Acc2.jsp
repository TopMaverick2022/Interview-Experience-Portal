...
<head>
    ...
    <title>Accenture Interviewee Page</title>
    ...
    <div class="container">
        <%
            try {
                ...
                ResultSet rs = s.executeQuery("SELECT name, companyname, interview_date, description FROM interviewee WHERE companyname = 'Accenture'");
